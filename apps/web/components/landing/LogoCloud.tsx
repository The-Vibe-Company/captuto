...
export function LogoCloud() {
  return (
    <section className="border-y border-stone-200/60 bg-white py-12">
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          Works with every web app you use
        </motion.p>
        ...
        >
          <div className="flex animate-marquee">
            ...
            {[...tools, ...tools].map((tool, i) => (
              <div
                key={`${tool.name}-${i}`}
                className="group mx-6 flex flex-shrink-0 items-center gap-2 opacity-40 grayscale transition-all duration-300 hover:opacity-100 hover:grayscale-0 sm:mx-10"
              >
                <tool.icon className="h-6 w-6 text-stone-600" />
