...
const steps = [
  {
    ...
    icon: Monitor,
    title: "Install",
    headline: "Connect CapTuto for Mac",
    description: "Download the recorder and connect it to your account.",
    color: "bg-brand-600",
    shadow: "shadow-brand",
    iconBg: "bg-brand-50",
  ...
  },
  {
    ...
    description:
      "Choose what to capture, start recording and walk through your workflow.",
    color: "bg-teal-600",
  ...
  },
  {
    ...
    icon: Wand2,
    title: "Generate",
    headline: "Choose screens, then generate",
    description:
      "Add the screens you want to your timeline. Edit them yourself or use AI generation, then review and share.",
    color: "bg-cyan-600",
